...
;(function () {
    ...
    document.write("<dd  class='foot_copyright'><span>京&nbsp;ICP&nbsp;证&nbsp;09002463&nbsp;号</span><span class='interval'>|</span><span>Copyright &copy; 1999-2018, CSDN.NET, All Rights Reserved&nbsp;</span><a href='http://www.hd315.gov.cn/beian/view.asp?bianhao=010202001032100010' target='_blank'><img src='"+protocol+"//csdnimg.cn/pubfooter/images/gongshang_logos.gif' alt='GongshangLogo' alt='' title='' /></a></dd>");
    document.write("</dl>");
    document.write("</div>");
    document.write("</div>");
