...
var mask = $('<div class="mask"></div>')
    ...
    h21 = $('<h2>发布成功</h2>')
    h22 = $('<h2>关注成功</h2>')
    con1 = $('<div class="con">该作者所有的新文章都可在<a href="http://blog.51cto.com/blog/follow" target="_blank">文章&gt;关注</a>中查看到</div><div class="con">关注并绑定官方微信服务号还可第一时间收到更新提醒</div>'),
    con2 = $('<div class="con">关注并绑定官方微信服务号可随时随地</div><div class="con">收到回复提醒</div>'),
    code_bg = $('<div class="code-bg"><iframe id="childframe" src="http://home.51cto.com/wechat/get-iframe-qr-code?reback='+location.href+'" iframeboder="0" scrolling="no" allowtransparency="true" style="border: 0 none;margin: 8px 14px;" width="120" height="120" name=""></iframe></div>')
