...
border-radius: 0;
		...
		.ugc a:focus
		{
			box-shadow: 0 1px 0 rgb(4, 103, 126);
...
font-weight: 600;
	...
	.subHeading a { color: rgb(4, 103, 126); }
...
.Menu
{
	...
	font-size: 13px;
border: 1px solid rgb(226, 226, 226);
border-top: 2px solid rgb(4, 103, 126);
overflow: hidden;
...
.userBanner.bannerOrange     { color: white; background-color: orange; border-color: #FFC520; }
